    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl font-bold text-white mb-2 tracking-tighter uppercase">Create Account</h1>
          <p className="text-slate-500 text-[10px] font-bold uppercase tracking-widest">Join DevHire today</p>
        </div>
